...
<div class="mb-6 flex items-center gap-3 bg-red-50 border border-red-200 rounded-xl px-5 py-4">
    ...
    <p class="text-sm font-medium text-red-800">
        ...
        <a href="{{ route('tenant.tasks.index') }}" class="underline ml-1">View tasks →</a>
    </p>
</div>
@endif
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
    ...
    <div class="xl:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <a href="{{ route('tenant.tasks.index') }}" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">
                View all →
            </a>
        </div>
        ...
        @if($recentTasks->isEmpty())
            <div class="flex flex-col items-center justify-center py-12 px-6 text-center">
                ...
                <a href="{{ route('tenant.tasks.create') }}" class="mt-3 text-sm text-indigo-600 font-medium hover:text-indigo-700">Create your first task →</a>
            </div>
        @else
    ...
    <div class="space-y-4">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('tenant.tasks.index', ['status' => 'pending']) }}"
                ...
                <a href="{{ route('tenant.tasks.index', ['status' => 'in_progress']) }}"
                   class="flex items-center gap-3 px-4 py-3 border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium text-gray-900">{{ $stats['total_users'] }}</span>
                </div>
                <div class="flex justify-between text-sm">
